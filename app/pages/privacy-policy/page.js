	...
	return (
		<>
			<main>
				...
				<section className="card ">
					<p>
						At grampic, accessible from https://grampic.com, one of our main
						priorities is the privacy of our visitors. This Privacy Policy document
						contains types of information that is collected and recorded by grampic
						and how we use it.
					</p>
					...
					<p>
						...
						and/or collect in grampic. This policy is not applicable to any
					...
					<h2 className="h3">Log Files</h2>

					<p>
						grampic follows a standard procedure of using log files. These files log
					...
					<h2 className="h3">Cookies and Web Beacons</h2>

					<p>
						Like any other website, grampic uses &quot;cookies&quot;. These cookies
					...
					<h2 className="h3">Google DoubleClick DART Cookie</h2>
					...
					<h2 className="h3">Advertising Partners Privacy Policies</h2>

					<p>
						You may consult this list to find the Privacy Policy for each of the
						advertising partners of grampic.
					</p>

					<p>
						Third-party ad servers or ad networks uses technologies like cookies,
						JavaScript, or Web Beacons that are used in their respective
						advertisements and links that appear on grampic, which are sent directly
					...
					<p>
						Note that grampic has no access to or control over these cookies that are
						used by third-party advertisers.
					</p>

					<h2 className="h3">Third Party Privacy Policies</h2>

					<p>
						grampic&apos;s Privacy Policy does not apply to other advertisers or
					...
					<h2 className="h3">GDPR Data Protection Rights</h2>
					...
					<p>
						grampic does not knowingly collect any Personal Identifiable Information
