		...
		<>
			<main>
				<section className="card">
					<h1 className="h2 text-center">Terms & Conditions</h1>
				</section>
				<section className="card ">
					<p>Welcome to grampic!</p>

					<p>
						These terms and conditions outline the rules and regulations for the use
						of GramPic&apos;s Website, located at https://grampic.com.
					</p>

					<p>
						By accessing this website we assume you accept these terms and conditions.
						Do not continue to use grampic if you do not agree to take all of the
					...
					<p>
						We employ the use of cookies. By accessing grampic, you agreed to use
						cookies in agreement with the GramPic&apos;s Privacy Policy.
					</p>
					...
					<p>
						Unless otherwise stated, GramPic and/or its licensors own the intellectual
						property rights for all material on grampic. All intellectual property
						rights are reserved. You may access this from grampic for your own
						personal use subjected to restrictions set in these terms and conditions.
					</p>

					<p>You must not:</p>
					<ul>
						<li>Republish material from grampic</li>
						<li>Sell, rent or sub-license material from grampic</li>
						<li>Reproduce, duplicate or copy material from grampic</li>
						<li>Redistribute content from grampic</li>
					</ul>

					<p>
						Parts of this website offer an opportunity for users to post and exchange
						opinions and information in certain areas of the website. GramPic does not
						filter, edit, publish or review Comments prior to their presence on the
						website. Comments do not reflect the views and opinions of GramPic,its
						...
						applicable laws, GramPic shall not be liable for the Comments or for any
					...
					<p>
						GramPic reserves the right to monitor all Comments and to remove any
					...
					<p>
						You hereby grant GramPic a non-exclusive license to use, reproduce, edit
					...
					<p>
						...
						hyperlink compensates the absence of GramPic; and (d) the link is in the
					...
					<p>
						...
						e-mail to GramPic. Please include your name, your organization name,
					...
					<p>
						No use of GramPic&apos;s logo or other artwork will be allowed for linking
